...
#Plot4.1
plot(datetime, HouseData$Global_active_power, col = "black", type= "l", xlab = "", ylab = "Global Active Power")

#Plot4.2
plot(datetime, HouseData$Voltage, col = "black", type= "l", xlab = "datetime", ylab = "Voltage")
...
legend("topright", lty = c(1,1,1), col = c("black", "red","blue"), bty = "n", cex = 0.85, legend = c("Sub_metering_1","Sub_metering_2","Sub_metering_3"))

#Plot4.4
plot(datetime, HouseData$Global_reactive_power, col = "black", type= "l", xlab = "datetime", ylab = "Global_reavtive_power")
